#Title: cancer_model_one_wider_flatter_features
#Date: 9 June 2018
...
#model of the wider flatter features that were seen in 
...
#----------------------------------------------------
# train a naive bayes model with wider flatter features
#----------------------------------------------------
model <- NaiveBayes(diagnosis~ . -texture_mean-texture_se-texture_worst
                    -smoothness_mean-smoothness_se-smoothness_worst 
                    - fractal_dimension_mean- fractal_dimension_se 
                    -fractal_dimension_worst- symmetry_mean- symmetry_se 
                    -symmetry_worst, data=data_train)
#----------------------------------------------------
# make predictions
#----------------------------------------------------
